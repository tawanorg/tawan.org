...
const TSIcon: React.FC<IIconBox> = (props) => {
  const color = useColorModeValue('#FFFFFF', 'brand.normal')
  return (
    (
      <Icon viewBox="0 0 512 512" {...props}>
        <path fill="currentColor" d="M512,256c0,23.155-3.072,45.599-8.84,66.936c-13.479,49.894-41.66,93.748-79.621,126.631
      C378.64,488.469,320.073,512,256,512C114.615,512,0,397.385,0,256S114.615,0,256,0S512,114.615,512,256z"/>
    <g>
      <path fill={color} d="M503.16,322.936c-13.479,49.894-41.66,93.748-79.621,126.631c-3.709,0.199-7.586,0.293-11.609,0.293
      ...
      <polygon fill={color} points="300.943,169.786 83.106,169.786 83.106,221.202 162.935,221.202 162.935,444.45 
